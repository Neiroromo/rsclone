                      ...
                      },
                      {
                        ...
                        value: function () {
                          ...
                          return [
                            ...
                            { name: 'moveDown', Tune: d.default },
                          ].map(function (e) {
                            var n = e.name;
                            return new (0,
                            e.Tune)({ api: t.api.getMethodsForTool(n, l.ToolType.Tune), settings: t.config });
                          });
                        },
                      },
                      {
                      ...
                      value: function (t) {
                        ...
                        o.sanitizeBlocks(t).forEach(function (t, e) {
                          ...
                          0 === e &&
                            ...
                            n.insert({ tool: o, data: i, replace: a });
                        });
                      },
                    },
                    {
                          ...
                          t.forEach(function (t) {
                            ...
                            d.log(i),
                              ...
                              r !== e.Editor.Tools.stubTool
                                ? o.push({ type: r, data: i })
                                : o.push(i);
                          }),
                          d.log('Total', 'log', n),
                          d.log(void 0, 'groupEnd'),
                          { time: +new Date(), blocks: o, version: '2.19.1' }
                        );
                      },
                    },
                  ]),
